...
#pragma config(Motor,  port2,           RDriveBase,    tmotorVex393_MC29, openLoop, reversed, driveRight, encoderPort, I2C_2)
#pragma config(Motor,  port3,           LDriveBase,    tmotorVex393_MC29, openLoop, driveLeft, encoderPort, I2C_1)
